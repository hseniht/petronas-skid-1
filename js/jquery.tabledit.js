        ...
        var defaults = {
            ...
            buttons: {
                edit: {
                    ...
                    html: '<span class="glyphicon glyphicon-pencil"><i class="fas fa-edit"></i></span>',
                    html2: '<span>Cancel</span>',
                    action: 'edit'
                },
                delete: {
                    class: 'btn btn-sm btn-default',
                ...
                toolbar: function() {
                    if (settings.editButton || settings.deleteButton) {
                        ...
                        if ($table.find('th.tabledit-toolbar-column').length === 0) {
                            $table.find('tr:first').append('<th class="tabledit-toolbar-column">Options</th>');
                        }
